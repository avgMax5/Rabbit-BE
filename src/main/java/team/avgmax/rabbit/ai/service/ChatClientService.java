                ...
                .user(u -> u
                        .text(
                            """
                                ...
                                요청: 위 정보를 바탕으로 이 개발자를 한 줄로 요약하라.
                                ...
                                출력 형식 예시:
                                - "탄탄한 백엔드 기술 역량과 자격증들을 바탕으로 장기적 가치가 기대되는 안정형 개발자"
                                - "8년차 금융권 백엔드 엔지니어 경력을 기반으로 가치를 인정받고 있는 개발자"
                                - "스타트업 CTO 경력과 대기업 플랫폼 팀장 경험으로 무궁한 성장성을 가진 성장형 개발자"
                                
                                작성 규칙:
                                1) 경력이 있다면: 구체적인 경력 년수, 회사 규모/업종, 포지션을 명시하고 기술스택을 보완적으로 언급
                                2) 경력이 없다면: 기술스택, 자격증, 학력을 중심으로 잠재력과 성장 가능성을 강조
                                3) 버니 지표를 반영하여 투자 성향 키워드(안정형, 성장형, 균형형 등)를 마지막에 포함
                                4) 불필요한 개인 정보(이름, 이메일, 생년월일)는 포함하지 말 것
                                5) 간결하고 전문적인 표현으로 작성할 것
                                6) 구체적인 수치나 경력 내용을 포함하여 신뢰성 있게 작성할 것
                ...
                .user(u -> u
                        .text(
                            """
                                ...
                                조건:
                                - 분량: 반드시 3문단 이내로 작성하고, 전체 길이는 500자 이내로 제한할 것
                                ...
                                - 톤: 전문적이고 친절하며 설득력 있게, 마치 코치가 조언하는 스타일. 마크다운 형식으로 작성할 것
                                - 반드시 500자 이내로만 작성하며, 불필요한 서론·결론은 피하고 핵심 개선 전략만 담을 것
